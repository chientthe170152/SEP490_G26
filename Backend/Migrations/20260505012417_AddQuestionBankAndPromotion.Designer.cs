...
namespace Backend.Migrations
{
    ...
    [Migration("20260505012417_AddQuestionBankAndPromotion")]
    partial class AddQuestionBankAndPromotion
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Backend.Models.QuestionBank", b =>
                {
                    ...
                    b.ToTable("QuestionBanks", t =>
                        {
                            t.HasCheckConstraint("CK_QB_NameNotEmpty", "LEN(LTRIM(RTRIM(Name))) > 0");

                            t.HasCheckConstraint("CK_QB_OwnerShape", "(OwnerType = 1 AND OwnerUserId IS NOT NULL) OR (OwnerType = 2 AND OwnerUserId IS NULL)");
                        });
                });

            modelBuilder.Entity("Backend.Models.QuestionPromotionRequest", b =>
                {
                    b.Property<int>("PromotionRequestId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PromotionRequestId"));
                    ...
                    b.Property<int>("SourcePersonalBankId")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("TargetSharedBankId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SourcePersonalBankId");

                    b.HasIndex("TargetSharedBankId");

                    b.ToTable("QuestionPromotionRequests");
                });

            modelBuilder.Entity("Backend.Models.QuestionPromotionRequestItem", b =>
                {
                    b.Property<int>("PromotionRequestId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("PromotionRequestId", "QuestionId");

                    b.HasIndex("QuestionId");

                    b.HasIndex("ResolvedByUserId");

                    b.ToTable("QuestionPromotionRequestItems", t =>
                        {
                            t.HasCheckConstraint("CK_QPRI_RejectionReason", "(Status = 3 AND RejectionReason IS NOT NULL AND LEN(LTRIM(RTRIM(RejectionReason))) > 0) OR Status <> 3");
                        });
                });
            ...
            modelBuilder.Entity("Backend.Models.QuestionPromotionRequest", b =>
                {
                    b.HasOne("Backend.Models.User", "RequestedByUser")
                        .WithMany("SentPromotionRequests")
                    ...
                    b.HasOne("Backend.Models.User", "ResolvedByUser")
                        .WithMany("ResolvedPromotionRequests")
                        .HasForeignKey("ResolvedByUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .HasConstraintName("FK_QPR_ResolvedBy");

                    b.HasOne("Backend.Models.QuestionBank", "SourcePersonalBank")
                        .WithMany("SourcePromotionRequests")
                        .HasForeignKey("SourcePersonalBankId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
                        .HasConstraintName("FK_QPR_Source");

                    b.HasOne("Backend.Models.QuestionBank", "TargetSharedBank")
                        .WithMany("TargetPromotionRequests")
                        .HasForeignKey("TargetSharedBankId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
                    ...
                    b.Navigation("SourcePersonalBank");

                    b.Navigation("TargetSharedBank");
                });

            modelBuilder.Entity("Backend.Models.QuestionPromotionRequestItem", b =>
                {
                    b.HasOne("Backend.Models.QuestionPromotionRequest", "Request")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Backend.Models.QuestionBank", b =>
                {
                    ...
                    b.Navigation("SourcePromotionRequests");

                    b.Navigation("TargetPromotionRequests");
                });
            ...
            modelBuilder.Entity("Backend.Models.User", b =>
                {
                    ...
                    b.Navigation("OwnedBanks");

                    b.Navigation("Questions");

                    b.Navigation("ResolvedPromotionRequests");

                    b.Navigation("SentPromotionRequests");
